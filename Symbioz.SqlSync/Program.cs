    ...
    class Program {
        ...
        public static void Synchronise() {
            ...
            foreach (var sub in arze) {
                var o = Extensions.XMLDeserialize<List<AmbientSound>>(sub.AmbientSounds).ConvertAll(x => x.Id);
        ...
        public static void ConnectToDatabase() {
            DatabaseManager manager = new DatabaseManager(Assembly.GetExecutingAssembly(),
                                                          SqlSyncConfiguration.Instance.DatabaseHost,
                                                          SqlSyncConfiguration.Instance.DatabaseName,
                                                          SqlSyncConfiguration.Instance.DatabaseUser,
                                                          SqlSyncConfiguration.Instance.DatabasePassword);
