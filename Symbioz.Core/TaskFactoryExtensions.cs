    ...
    public static class TaskFactoryExtensions {
        ...
        private static TaskContinuationOptions ContinuationOptionsFromCreationOptions(TaskCreationOptions creationOptions) {
            return (TaskContinuationOptions)
                ((creationOptions & TaskCreationOptions.AttachedToParent) | (creationOptions & TaskCreationOptions.PreferFairness) | (creationOptions & TaskCreationOptions.LongRunning));
        }
                ...
                try {
                    ...
                    if (enumerator.MoveNext()) {
                        ...
                        // enabling hopping between contexts.
                            ...
                            if (body != null)
                                Task.Factory.StartNew(() => body(null),
                                                      CancellationToken.None,
        ...
        public static Task StartNewDelayed(this TaskFactory factory,
            ...
            return StartNewDelayed(factory,
                                   millisecondsDelay,
                                   action,
                                   factory.CancellationToken,
                                   factory.CreationOptions,
