...
namespace Symbioz.ProtocolBuilder.Profiles {
    public abstract class ParsingProfile {
        ...
        [YAXDontSerialize]
        public SerializableDictionary<string, string> BeforeParsingReplacementRules { get; set; }
        ...
        public string GetRelativePath(string file) {
            ...
            string[] foldersSplitted = folder.Split(new[] { this.SourcePath.Replace("/", "\\")}, StringSplitOptions.RemoveEmptyEntries); // cut the source path and the "rest" of the path
