...
namespace Symbioz.ProtocolBuilder {
    public class BuilderConfiguration {
        ...
        public static void Initialize() {
            Instance = Load<BuilderConfiguration>(CONFIG_NAME);
        }
        ...
        public XmlMessagesProfile XmlMessagesProfile { get; set; }
        public XmlTypesProfile XmlTypesProfile { get; set; }
        public MessagesProfile MessagesProfile { get; set; }
        public TypesProfile TypesProfile { get; set; }
        public EnumsProfile EnumsProfile { get; set; }

        public void Default() {
            this.Output = "./";

            this.SourcePath = "./sources/";
            this.BaseNamespace = "Symbioz.Protocol";
            this.UseIEnumerable = false;

            this.XmlMessagesProfile =
