...
namespace Symbioz.ProtocolBuilder.Templates {
    public class TemplateHost : ITextTemplatingEngineHost, ITextTemplatingSessionHost {
        ...
        public TemplateHost(string templateFileValue) {
            this.m_templateFileValue = templateFileValue;
        }

        public string FileExtension {
            get { return this.m_fileExtensionValue; }
            set { this.m_fileExtensionValue = value; }
        }
        ...
        public Encoding FileEncoding {
            get { return this.m_fileEncodingValue; }
            set { this.m_fileEncodingValue = value; }
        }
        ...
        public CompilerErrorCollection Errors {
            get { return this.m_errorsValue; }
        }

        #region ITextTemplatingEngineHost Members

        public string TemplateFile {
            get { return this.m_templateFileValue; }
        }
        ...
        public void SetFileExtension(string extension) {
            ...
            //--------------------------------------------------------
            this.m_fileExtensionValue = extension;
        }
        ...
        public void SetOutputEncoding(Encoding encoding, bool fromOutputDirective) {
            this.m_fileEncodingValue = encoding;
        }
