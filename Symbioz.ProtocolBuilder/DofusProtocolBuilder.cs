    ...
    class DofusProtocolBuilder : Singleton<DofusProtocolBuilder> {
        ...
        public void Build() {
            ...
            foreach (ParsingProfile parsingProfile in profiles) {
                ...
                IEnumerable<string> files = Directory.EnumerateFiles(Path.Combine(BuilderConfiguration.Instance.SourcePath, parsingProfile.SourcePath),
                                                                     "*.as",
                ...
                foreach (string file in files) {
                    ...
                    var parser = new Parser(file,
                                            parsingProfile.BeforeParsingReplacementRules,
                ...
                this.logger.White(parsingProfile.Name + " done!");
            }
        }
