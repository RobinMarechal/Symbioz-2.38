...
namespace Symbioz.Auth.Records {
    ...
    public class AccountRecord : ITable {
        ...
        [Ignore]
        public ServerRoleEnum RoleEnum {
            get { return (ServerRoleEnum) this.Role; }
        }
        ...
        public AccountData ToAccountData() {
            return new AccountData(this.Id, this.Username, this.Password, this.Nickname, this.Banned, this.CharacterSlots, this.Role, this.LastSelectedServerId);
        }
        ...
        static AccountRecord ToAccountRecord(AccountData accountData) {
            return new AccountRecord(accountData.Id,
                                     accountData.Username,
                                     accountData.Password,
                                     accountData.Nickname,
                                     (sbyte) accountData.Role,
                                     accountData.Banned,
                                     accountData.CharacterSlots,
                                     accountData.LastSelectedServerId);
        }
