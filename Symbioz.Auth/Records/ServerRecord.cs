...
namespace Symbioz.Auth.Records {
    ...
    public class ServerRecord : ITable {
        ...
        public GameServerInformations GetServerInformations(AccountData account) {
            return new GameServerInformations(this.Id, this.Type, (sbyte) this.Status, 0, true, ServerCharacterRecord.GetCharactersCount(this.Id, account.Id), account.CharacterSlots, 0);
        }
