...
namespace SSync
{
    public static class Extensions
    {
        ...
        {
            List<ParameterExpression> list = Enumerable.ToList<ParameterExpression>(Enumerable.Select<ParameterInfo, ParameterExpression>(ctor.GetParameters(), param => Expression.Parameter(param.ParameterType)));
            return Expression.Lambda<T>(Expression.New(ctor, list), list).Compile();
        }
