    ...
    public class BufferSegment {
        ...
        public byte[] SegmentData {
            get {
                ...
                System.Buffer.BlockCopy(this.Buffer.Array, this.Offset, bytes, 0, this.Length);
        ...
        public void CopyFrom(byte[] bytes, int offset) {
            System.Buffer.BlockCopy(bytes, offset, this.Buffer.Array, this.Offset + offset, (bytes.Length - offset));
        }
        ...
        public void CopyTo(BufferSegment segment, int length) {
            System.Buffer.BlockCopy(this.Buffer.Array, this.Offset, segment.Buffer.Array, segment.Offset, length);
        }
