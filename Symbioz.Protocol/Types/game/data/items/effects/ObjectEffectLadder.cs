...
namespace Symbioz.Protocol.Types {
    public class ObjectEffectLadder : ObjectEffectCreature {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhInt(this.monsterCount);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.monsterCount < 0)
                throw new Exception("Forbidden value on monsterCount = " + this.monsterCount + ", it doesn't respect the following condition : monsterCount < 0");
        }
    }
}