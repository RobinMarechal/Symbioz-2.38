...
namespace Symbioz.Protocol.Types {
    public class ObjectEffectCreature : ObjectEffect {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhShort(this.monsterFamilyId);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.monsterFamilyId < 0)
                throw new Exception("Forbidden value on monsterFamilyId = " + this.monsterFamilyId + ", it doesn't respect the following condition : monsterFamilyId < 0");
        }
    }
}