...
namespace Symbioz.Protocol.Types {
    public class FightTemporarySpellBoostEffect : FightTemporaryBoostEffect {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhShort(this.boostedSpellId);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.boostedSpellId < 0)
                throw new Exception("Forbidden value on boostedSpellId = " + this.boostedSpellId + ", it doesn't respect the following condition : boostedSpellId < 0");
        }
    }
}