...
namespace Symbioz.Protocol.Messages {
    public class ObtainedItemWithBonusMessage : ObtainedItemMessage {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhInt(this.bonusQuantity);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.bonusQuantity < 0)
                throw new Exception("Forbidden value on bonusQuantity = " + this.bonusQuantity + ", it doesn't respect the following condition : bonusQuantity < 0");
        }
    }
}