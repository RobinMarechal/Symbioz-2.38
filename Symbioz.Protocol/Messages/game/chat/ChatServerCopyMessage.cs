...
namespace Symbioz.Protocol.Messages {
    public class ChatServerCopyMessage : ChatAbstractServerMessage {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhLong(this.receiverId);
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.receiverId < 0 || this.receiverId > 9007199254740990)
                throw new Exception("Forbidden value on receiverId = " + this.receiverId + ", it doesn't respect the following condition : receiverId < 0 || receiverId > 9007199254740990");
