...
namespace Symbioz.Protocol.Messages {
    public class GameActionFightLifeAndShieldPointsLostMessage : GameActionFightLifePointsLostMessage {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhShort(this.shieldLoss);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.shieldLoss < 0)
                throw new Exception("Forbidden value on shieldLoss = " + this.shieldLoss + ", it doesn't respect the following condition : shieldLoss < 0");
        }
    }
}