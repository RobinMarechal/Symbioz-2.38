...
namespace Symbioz.Protocol.Messages {
    public class GameActionFightNoSpellCastMessage : Message {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            writer.WriteVarUhInt(this.spellLevelId);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.spellLevelId < 0)
                throw new Exception("Forbidden value on spellLevelId = " + this.spellLevelId + ", it doesn't respect the following condition : spellLevelId < 0");
        }
    }
}