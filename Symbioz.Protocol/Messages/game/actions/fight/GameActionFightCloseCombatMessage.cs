...
namespace Symbioz.Protocol.Messages {
    public class GameActionFightCloseCombatMessage : AbstractGameActionFightTargetedAbilityMessage {
        ...
        public override void Serialize(ICustomDataOutput writer) {
            ...
            writer.WriteVarUhShort(this.weaponGenericId);
        }
        ...
        public override void Deserialize(ICustomDataInput reader) {
            ...
            if (this.weaponGenericId < 0)
                throw new Exception("Forbidden value on weaponGenericId = " + this.weaponGenericId + ", it doesn't respect the following condition : weaponGenericId < 0");
        }
    }
}