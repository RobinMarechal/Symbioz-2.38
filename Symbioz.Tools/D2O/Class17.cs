...
namespace Symbioz.Tools.D2O {
    internal sealed class Class17 {
        ...
        private Delegate0 method_0(int int_0, BigEndianReader dofusReader_0) {
            switch (int_0) {
                ...
                case -99:
                    ...
                    this.class17_0 = new Class17(this.D2oData, str, dofusReader_0);
        ...
        private object method_2(string string_1, BigEndianReader dofusReader_0) {
            ...
            if (this.D2oData.dictionary_0.ContainsKey(num))
                return this.D2oData.dictionary_0[num].method_0(string_1, dofusReader_0);
            else
                return null;
        }
