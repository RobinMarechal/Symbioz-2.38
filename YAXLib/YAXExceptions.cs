...
namespace YAXLib {
    ...
    public class YAXElementValueMissingException : YAXException {
        ...
        /// </returns>
        public override string Message {
            get { return String.Format(CultureInfo.CurrentCulture, "Element with the given name does not contain text values: '{0}'.", this.ElementName); }
        }
    ...
    public class YAXElementValueAlreadyExistsException : YAXException {
        ...
        /// </returns>
        public override string Message {
            get { return String.Format(CultureInfo.CurrentCulture, "Element with the given name already has value: '{0}'.", this.ElementName); }
        }
