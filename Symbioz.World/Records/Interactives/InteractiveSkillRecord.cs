...
namespace Symbioz.World.Records.Interactives
{
    ...
    public class InteractiveSkillRecord : ITable
    {
        ...
        [Update] public int ElementId;

        public ushort SkillId;

        public InteractiveSkillRecord(int uid, string actionType, string value1, string value2, int elementId, ushort skillId)
        {
            this.UID = uid;
        ...
        public InteractiveSkillRecord(string actionType, string value1, string value2, int elementId, ushort skillId)
        {
            this.ActionType = actionType;
            this.Value1 = value1;
            this.Value2 = value2;
