...
namespace Symbioz.World {
    public class WorldConfiguration : ServerConfiguration {
        ...
        public static void Initialize() {
            Instance = Load<WorldConfiguration>(CONFIG_NAME);
        }
        ...
        public bool UseCustomHost { get; set; }
        ...
        public sbyte ServerType { get; set; }

        public int SaveInterval { get; set; }

        public bool PerformBackup { get; set; }

        public int StartMapId { get; set; }

        public ushort StartCellId { get; set; }

        public int StartKamas { get; set; }

        public int KamasRate { get; set; }

        public int DropsRate { get; set; }

        public int CraftRate { get; set; }
        ...
        public short ApLimit { get; set; }
        public short MpLimit { get; set; }
