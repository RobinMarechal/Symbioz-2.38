...
namespace Symbioz.World.Models.Fights.FightModels {
    public class SpellHistoryEntry {
        public SpellHistory History { get; private set; }
        public SpellLevelRecord Spell { get; private set; }
        public Fighter Caster { get; private set; }
        public Fighter Target { get; private set; }
        public int CastRound { get; private set; }
        ...
        public bool IsGlobalCooldownActive(int currentRound) {
            return this.GetElapsedRounds(currentRound) < (long) ((ulong) this.Spell.MinCastInterval);
        }
    }
}