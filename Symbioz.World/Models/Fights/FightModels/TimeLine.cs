...
namespace Symbioz.World.Models.Fights.FightModels {
    public class TimeLine {
        internal List<Fighter> Fighters { get; private set; }
        public Fight Fight { get; private set; }

        public Fighter Current {
            get { return (this.Index == -1 || this.Index >= this.Fighters.Count) ? null : this.Fighters[this.Index]; }
        }

        public int Index { get; private set; }

        public int Count {
            get { return this.Fighters.Count; }
        }

        public uint RoundNumber { get; private set; }
        public bool NewRound { get; private set; }
        ...
        public void OrderLine() {
            ...
            IEnumerator<Fighter> enumerator = orderedEnumerable.GetEnumerator();
            IEnumerator<Fighter> enumerator2 = orderedEnumerable2.GetEnumerator();
        ...
        public double[] GetIds() {
            return this.Fighters.FindAll(x => x.Alive).ConvertAll<double>(x => x.Id).ToArray();
        }
    }
}