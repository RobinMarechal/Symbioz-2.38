...
namespace Symbioz.World.Models.Fights.FightModels {
    public class SpellHistory {
        ...
        private int CurrentRound {
            get { return (int) this.Owner.Fight.TimeLine.RoundNumber; }
        }
        ...
        public bool CanCastSpell(SpellLevelRecord spell, short targetedCell) {
            ...
            bool result;
            if (spellHistoryEntry == null && this.CurrentRound < (long) ((ulong) spell.InitialCooldown)) {
                result = false;
            }
                ...
                if (array.Length == 0) {
                ...
                else if (spell.MaxCastPerTurn > 0u && array.Length >= (long) ((ulong) spell.MaxCastPerTurn)) {
                    result = false;
                }
                else {
                    ...
                    if (target == null) {
                        ...
                        result = (spell.MaxCastPerTarget <= 0u || num < (long) ((ulong) spell.MaxCastPerTarget));
                    }
                }
            }
        ...
        public bool CanCastSpell(SpellLevelRecord spell) {
            ...
            if (spellHistoryEntry == null && this.CurrentRound < (long) ((ulong) spell.InitialCooldown)) {
                ...
                SpellHistoryEntry[] array = (
                                                ...
                                                where entry.Spell.Id == spell.Id && entry.CastRound == this.CurrentRound
                                                select entry).ToArray<SpellHistoryEntry>();
                result = (array.Length == 0 || spell.MaxCastPerTurn <= 0u || array.Length < (long) ((ulong) spell.MaxCastPerTurn));
            }
