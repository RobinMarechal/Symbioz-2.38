...
namespace Symbioz.World.Models.Entities.HumanOptions {
    public class CharacterHumanOptionGuild : CharacterHumanOption {
        ...
        public ContextGuildEmblem Emblem { get; set; }
        ...
        public override HumanOption GetHumanOption() {
            return new HumanOptionGuild(new GuildInformations(this.GuildId, this.GuildName, this.GuildLevel, this.Emblem.ToGuildEmblem()));
        }
    }
}