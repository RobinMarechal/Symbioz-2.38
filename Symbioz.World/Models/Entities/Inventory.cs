...
namespace Symbioz.World.Models.Entities {
    ...
    public class Inventory : ItemCollection<CharacterItemRecord> {
        ...
        /// </summary>
        public const short PET_MOUNT_SIZE = 100;

        /// <summary>
        /// Quantitée maximum de kamas autorisé dans l'inventaire
        /// </summary>
        public const int MAX_KAMAS = 2000000000;
        ...
        public uint TotalWeight {
            get { return FormulasProvider.Instance.TotalWeight(Character); }
        }

        public List<CharacterMountRecord> Mounts { get; private set; }

        public CharacterMountRecord Mount {
            get { return Mounts.FirstOrDefault(x => x.Setted); }
        }
        ...
        public Inventory(Character character)
            ...
            this.OnItemsCollectionChanged += Inventory_OnItemsCollectionChanged;
        ...
        void Inventory_OnItemsCollectionChanged() {
            Refresh();
        }
        ...
        private void UpdatePetLook(CharacterItemRecord item, bool equiped) {
            if (equiped) {
                Character.Look.AddPetSkin(item.AppearanceId, PET_SIZE);
            }
            else {
