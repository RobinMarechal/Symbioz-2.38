...
namespace Symbioz.World.Models.Entities.Stats {
    public class FighterStats : Stats {
        public int LifePercentage {
            get { return CurrentLifePoints.Percentage(CurrentMaxLifePoints); }
        }

        public int MpPercentage {
            get { return ((int) MovementPoints.TotalInContext()).Percentage(MovementPoints.Total()); }
        }

        public double FinalDamageCoefficient = 1;

        public int LifeLost {
            get { return CurrentMaxLifePoints - CurrentLifePoints; }
        }

        public int CurrentLifePoints { get; set; }
        public int Erosion { get; set; }
        public int CurrentMaxLifePoints { get; set; }

        public int ErrodedLife {
            get { return MaxLifePoints - CurrentMaxLifePoints; }
        }

        public short MpUsed { get; set; }
        public short ApUsed { get; set; }
