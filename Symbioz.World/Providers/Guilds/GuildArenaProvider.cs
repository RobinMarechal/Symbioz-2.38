...
namespace Symbioz.World.Providers.Guilds {
    ...
    class GuildArenaProvider {
        ...
        private static bool IsFightDay {
            get { return FIGHT_DAYS.Contains(DateTime.Now.DayOfWeek); }
        }

        private static bool SortNeeded {
            get { return GuildArenaRecord.Sorted() == false && (DRESS_ARRAY_DAY >= DateTime.Now.DayOfWeek || FIGHT_DAYS.Contains(DRESS_ARRAY_DAY)); }
        }
