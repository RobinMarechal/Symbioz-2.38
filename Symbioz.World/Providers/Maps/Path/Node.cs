...
namespace Symbioz.World.Providers.Maps.Path {
    internal class Node : INode {
        ...
        // PROPERTIES
        public short CellID {
            get { return this.m_cell.Id; }
        }

        public List<_cell> Neighbors {
            get { return this.m_cell.Line; }
        }

        public sbyte X {
            get { return this.m_cell.X; }
        }

        public sbyte Y {
            get { return this.m_cell.Y; }
        }
