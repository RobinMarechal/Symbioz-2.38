...
namespace Symbioz.World.Providers.Brain.Behaviors {
    public abstract class Behavior {
        ...
        protected BrainFighter Fighter { get; set; }
        ...
        public void MakeInvulnerable(Fighter target, short duration) {
            ...
            if (sequence) this.Fighter.Fight.SequencesManager.EndSequence(SequenceTypeEnum.SEQUENCE_SPELL);
        }
        ...
        public void MakeVulnerable(Fighter target) {
            bool sequence = this.Fighter.Fight.SequencesManager.StartSequence(SequenceTypeEnum.SEQUENCE_SPELL);
            this.Fighter.DispellSpellBuffs(target, InvunlerabilitySpellId);
            if (sequence) this.Fighter.Fight.SequencesManager.EndSequence(SequenceTypeEnum.SEQUENCE_SPELL);
        }
