...
namespace Symbioz.World.Providers.Brain.Behaviors {
    ...
    public class Joris : Behavior {
        ...
        void Fighter_OnDamageTaken(Fighter fighter, Damage obj) {
            obj.Source.SwitchPosition(this.Fighter);
        ...
        void AddPermanemtMovementPoints(short delta) {
            this.Fighter.Stats.MovementPoints.Context += delta;
            this.Fighter.Fight.PointsVariation(this.Fighter.Id, this.Fighter.Id, ActionsEnum.ACTION_CHARACTER_MOVEMENT_POINTS_WIN, delta);
        }
    }
}