...
namespace Symbioz.World.Providers.Fights.Effects.Marks {
    ...
    public class ActiveGlyph : SpellEffectHandler {
        public ActiveGlyph(Fighter source,
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (var glyph in this.Fight.GetMarks<Glyph>(x => x.BaseEffect.EffectEnum == EffectsEnum.Effect_Glyph && x.Source == this.Source && x.ContainsCell(this.Source.CellId))) {
                glyph.Activate(this.Source);
            }
