...
namespace Symbioz.World.Providers.Fights.Effects.Buffs {
    ...
    public class StatsSteal : SpellEffectHandler {
        public StatsSteal(Fighter source,
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (Fighter current in targets) {
                ...
                this.AddStatBuff(current, (short) -this.Effect.DiceMin, GetEffectCaracteristic(current, this.Effect.EffectEnum), FightDispellableEnum.DISPELLABLE, (short) buffDisplayedEffect[1]);
                this.AddStatBuff(this.Source, (short) this.Effect.DiceMin, GetEffectCaracteristic(this.Source, this.Effect.EffectEnum), FightDispellableEnum.DISPELLABLE, (short) buffDisplayedEffect[0]);
            }
