    ...
    public class Armor : SpellEffectHandler {
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (var target in targets) {
                ArmorBuff buff = new ArmorBuff(target.BuffIdProvider.Pop(), target, this.Source, this.SpellLevel, this.Effect, this.SpellId, (short) this.Effect.RandomizeMinMax(), this.Critical, FightDispellableEnum.DISPELLABLE);
