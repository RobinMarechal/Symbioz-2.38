...
namespace Symbioz.World.Providers.Fights.Effects.Buffs {
    ...
    public class BoostSpell : SpellEffectHandler {
        public BoostSpell(Fighter source,
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (var target in targets) {
                SpellBoost buff = new SpellBoost(target.BuffIdProvider.Pop(), target, this.Source, this.SpellLevel, this.Effect, this.SpellId, this.Critical, FightDispellableEnum.REALLY_NOT_DISPELLABLE);
