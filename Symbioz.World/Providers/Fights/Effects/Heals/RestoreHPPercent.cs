...
namespace Symbioz.World.Providers.Fights.Effects.Heals {
    ...
    public class RestoreHPPercent : SpellEffectHandler {
        public RestoreHPPercent(Fighter source,
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (var target in targets) {
                short delta = (short) target.Stats.CurrentMaxLifePoints.GetPercentageOf(this.Effect.DiceMin);
                target.Heal(this.Source, delta);
            }
