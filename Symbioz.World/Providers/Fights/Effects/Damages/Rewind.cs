...
namespace Symbioz.World.Providers.Fights.Effects.Damages {
    ...
    public class Rewind : SpellEffectHandler {
        public short ImpactPercentage { get; private set; }

        public Rewind(Fighter source,
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (var target in targets) {
                this.AddTriggerBuff(target, FightDispellableEnum.REALLY_NOT_DISPELLABLE, TriggerType.BEFORE_ATTACKED | TriggerType.AFTER_ATTACKED, this.AfterAttacked);
            }
        ...
        private bool AfterAttacked(TriggerBuff buff, TriggerType trigger, object token) {
            ...
            short impactDamages = (short) (((int) damages.Delta).GetPercentageOf(this.ImpactPercentage));
