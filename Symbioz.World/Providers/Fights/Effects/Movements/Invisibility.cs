...
namespace Symbioz.World.Providers.Fights.Effects.Movements {
    ...
    public class Invisibility : SpellEffectHandler {
        ...
        public Invisibility(Fighter source,
        ...
        public override bool Apply(Fighter[] targets) {
            foreach (var target in targets) {
                InvisibilityBuff buff = new InvisibilityBuff(target.BuffIdProvider.Pop(), target, this.Source, this.SpellLevel, this.Effect, this.SpellId, this.Critical, FightDispellableEnum.DISPELLABLE);
