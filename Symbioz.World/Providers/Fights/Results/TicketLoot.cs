...
namespace Symbioz.World.Providers.Fights.Results {
    ...
    public class DayFightLoot : CustomLoot {
        ...
        public override void Apply() {
            int count = this.Result.Fighter.OposedTeam().GetFighters<MonsterFighter>(false).Count * 6;
            if (count > 0)
    ...
    public class TicketLoot : CustomLoot {
        ...
        public override void Apply() {
            ...
            foreach (var monster in this.Result.Fighter.OposedTeam().GetFighters<MonsterFighter>(false)) {
            ...
            this.Add(17745, this.GetGoldenTicketsCount(this.Result.ExperienceData.ExperienceFightDelta));
        }
