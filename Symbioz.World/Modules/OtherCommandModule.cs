            ...
            if (client.Character.Level == 200 && !client.Character.Fighting) {
                if (client.Character.Record.Prestige < MaxPrestige) {
                    ...
                    if (client.Character.Record.Prestige == MaxPrestige) {
                        ...
                        WorldServer.Instance.OnClients(x => x.Character.Reply(client.Character.Name
                                                                              + " vient de passer prestige <b>"
                                                                              + MaxPrestige
                                                                              + "</b> ! Félicitation a lui. QUEL HOMME !!, il obtient une émote et un titre légendaire!",
                                                                              Color.BlueViolet));
                    }
                    else {
                    ...
                    client.Character.OpenPopup(0,
                                               "Amnesia",
                                               "Vous venez de passer au rang de prestige "
                                               + client.Character.Record.Prestige
                                               + Environment.NewLine
                                               + "Vous repassez niveau 1 et vous avez acquis des bonus permanents que vous pouvez consulter dans le chat."
                                               + Environment.NewLine
